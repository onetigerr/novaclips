# Подробный план производства Faceless YouTube роликов
...
**Артефакты:**
- `idea-brief.yaml` — краткое описание идеи
...
**Артефакты:**
- `shotlist.yaml` — сцены с типами визуалов и промптами
...
**Артефакты:**
- `audio/voice.mp3` — финальная озвучка
